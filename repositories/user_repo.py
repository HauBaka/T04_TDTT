...
class UserRepository(BaseRepository):
    ...
    async def batch_update_users(self, uids: list[str], update_data: list[dict]) -> bool:
        """
    ...
    async def save_collection(self, requester_uid: str, collection_id: str) -> bool:
        ...
        batch.set(self._collection.document(requester_uid).collection("saved_collections").document(collection_id), saved_collection_doc.model_dump(mode="python"))
    ...
    async def unsave_collection(self, requester_uid: str, collection_id: str) -> bool:
        ...
        batch.delete(self._collection.document(requester_uid).collection("saved_collections").document(collection_id))
