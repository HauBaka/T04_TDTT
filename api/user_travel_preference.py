...
async def get_travel_preference(
    ...
    return await user_service.get_travel_preference(uid)
...
async def update_my_travel_preference(
    ...
    uid = requester.get("uid")
    return await user_service.update_travel_preference(uid, preference)
...
async def delete_travel_preference(
    ...
    uid = requester.get("uid")
    return await user_service.delete_travel_preference(uid)
