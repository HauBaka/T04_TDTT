...
@notification_router.delete(
    "/users/me/notifications/{notification_id}", response_model=ResponseSchema[bool]
)
async def delete_notification(
    notification_id: str, requester=Depends(get_current_user(optional=False))
):
    """Xóa một thông báo cụ thể."""
    return await notification_service.delete_notification(
        notification_id, requester.get("uid")
    )
